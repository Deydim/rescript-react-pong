              ...
              className: "App"
                  ...
                  className: "App-header"
                      ...
                      src: logo
                        ...
                        }, "count is: " + String(match[0]))), React.createElement("p", undefined, "Editss ", React.createElement("code", undefined, "App.res"), " and save to test HMR updates."), React.createElement("p", undefined, React.createElement("a", {
                          className: "App-link",
                          href: "https://reactjs.org",
                          rel: "noopener noreferrer",
                          target: "_blank"
                        }, "Learn Reacts"), " | ", React.createElement("a", {
                          className: "App-link",
